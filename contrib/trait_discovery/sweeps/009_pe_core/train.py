def make_cfgs() -> list[dict]:
    ...
    # PE-core ViT-L/14 activations on ImageNet-1K (576 tokens, layers 13-23)
    pe_core_in1k_train = "/fs/scratch/PAS2136/samuelstevens/saev/shards/6d03937c"
        ...
        for layer in [21, 23]:
            for k in [16, 32, 64, 128, 256]:
                cfgs.append({
                    ...
                    "train_data": {
                        "layer": layer,
                        "shards": pe_core_in1k_train,
                        "min_buffer_fill": 0.2,
                    },
                    "val_data": {
                        "layer": layer,
                        "shards": pe_core_in1k_val,
                    },
                })
    return cfgs
