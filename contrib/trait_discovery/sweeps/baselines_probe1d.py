# uv run scripts/launch.py probe1d --run /fs/ess/PAS2136/samuelstevens/tdiscovery/saev/runs/33hl36sz/ --train-shards /fs/scratch/PAS2136/samuelstevens/saev/shards/614861a0/ --test-shards /fs/scratch/PAS2136/samuelstevens/saev/shards/3802cb66/
...
def make_cfgs() -> list[dict]:
    ...
    for method, run_id, *_ in kmeans_runs + pca_runs + semi_nmf_runs:
        cfgs.append({
            # "method": method,
