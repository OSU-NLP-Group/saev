def make_cfgs():
    ...
    fishvista_run_ids = {
        13: ["nz4kbwrg", "7mutzotf", "14byzh33", "u5w7spva", "swkzf6h4", "1liq98bm"],
        15: ["k0mpsqkk", "np180i6p", "5x0q8dp8", "qft1m6z1", "q9v1m71c", "y2qs0ei9"],
        17: ["220wrvvr", "uqn5b99y", "jmvt870b", "roc94btc", "q7qmy8w1", "odyp6oke"],
        19: ["aql7nsgb", "umh8wxrg", "rh0amlbo", "jdxh601v", "9gi0f31g", "757wfw38"],
        21: ["b7xtriqt", "xkow5w0y", "im0wwtm8", "hh35eaw9", "5f2p2pes", "pouei803"],
        23: ["gi8l3pk1", "x0mkt04y", "c3yusm40", "um6hbn05", "r0m5713d", "i6z66rly"],
    }
    in1k_run_ids = {
    ...
    for layer, ids in in1k_run_ids.items():
        for shards in [dinov3_ade20k_train, dinov3_ade20k_val]:
            for id in ids:
                cfgs.append({
                    "run": os.path.join(run_root, id),
                    "data": {"shards": shards, "layer": layer},
