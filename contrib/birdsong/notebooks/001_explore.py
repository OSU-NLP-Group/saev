...
def _(collections, df, itertools, mo, pl, plt, saev):
    def _(df: pl.DataFrame):
        ...
        data_keys = ["BirdCLEF/train_audio"]
        ...
        fig.savefig("contrib/trait_discovery/docs/assets/birdclef-pareto-mse.pdf")
        # return fig
...
@app.cell
def _(df, itertools, pl, plt, saev):
    def _(df: pl.DataFrame):
        # mse_col = "ade20k_val_nmse"
        x_col = "config/lr"
        y_col = "summary/eval/normalized_mse"
...
def _(base64, beartype, pickle, saev):
    ...
    def get_model_key(metadata: dict[str, object]) -> str:
        ...
        if family == "bird-mae" and ckpt == "Bird-MAE-Large":
            return "BirdMAE-L"
    ...
    def get_data_key(metadata: dict[str, object]) -> str | None:
        ...
        if isinstance(data_cfg, saev.data.datasets.BirdClef2025):
            return f"BirdCLEF/{data_cfg.split}"
